...
extern	int			SetWindowZOrder(						int ZType /* = DX_WIN_ZTYPE_TOP 等 */ ) ;											// メインウインドウの奥行き位置を変更する
...
extern	int			SetScreenFlipTargetWindow(		HWND TargetWindow ) ;															// ScreenFlip で画像を転送する先のウインドウを設定する( NULL を指定すると設定解除 )
